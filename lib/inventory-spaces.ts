...
export const INVENTORY_SPACE_PALETTES = {
  ...
  InventorySpaceKey,
  {
    ...
    secondaryActionBubble: string;
    inlineActionBackground: string;
    inlineActionForeground: string;
    primaryActionMutedText: string;
    secondaryActionMutedText: string;
    tabActiveBackground: string;
    tabActiveMeta: string;
    tabActiveText: string;
    sectionTint: string;
    sectionTintBorder: string;
  }
>;

export function normalizeInventorySpace(value: string | null | undefined) {
  if (!value) {
    return null;
  }
